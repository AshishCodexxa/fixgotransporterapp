...
class LoadMoreBidPostInfoDialog extends StatefulWidget {
  ...
  const LoadMoreBidPostInfoDialog({Key? key, required this.postDetails, required this.postIndex, this.pickupDate = '', this.pickupTime ='', this.pickupLocation = '', this.finalLocation = '', this.isComeFrom = ""}) : super(key: key);

  @override
  State<LoadMoreBidPostInfoDialog> createState() => _LoadMoreBidPostInfoDialogState();
}

class _LoadMoreBidPostInfoDialogState extends State<LoadMoreBidPostInfoDialog> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${widget.postDetails[widget.postIndex].post?.loadDetail?.loadType}",
                  style: TextStyle(
                      color: Colors.black,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text("${widget.postDetails[widget.postIndex].post?.loadDetail?.load} ${widget.postDetails[widget.postIndex].post?.loadDetail?.loadUnit}",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: SizeConfig.blockSizeHorizontal*3.2,
                              fontWeight: FontWeight.w400,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text("${widget.postDetails[widget.postIndex].post?.loadDetail?.description}",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: SizeConfig.blockSizeHorizontal*3.0,
                              fontWeight: FontWeight.w400,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("${widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType}",
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: SizeConfig.blockSizeHorizontal*3.2,
                          fontWeight: FontWeight.w500,
                   ...
                   /* Visibility(
                      visible: widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType == "Trailor" ? true : false,
                      child: Padding(
                        padding: EdgeInsets.only(left: parentWidth*0.01),
                        child: Text("(${widget.postDetails[widget.postIndex].post?.vehicle?.trailorType})",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: SizeConfig.blockSizeHorizontal*3.2,
                              fontWeight: FontWeight.w500,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text("${widget.postDetails[widget.postIndex].post?.vehicle?.capacity} ${widget.postDetails[widget.postIndex].post?.vehicle?.capacityUnit}",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: SizeConfig.blockSizeHorizontal*3.2,
                              fontWeight: FontWeight.w400,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${widget.postDetails[widget.postIndex].post?.vehicle?.quantity}",
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: SizeConfig.blockSizeHorizontal*3.2,
                      fontWeight: FontWeight.w500,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text("L - ${widget.postDetails[widget.postIndex].post?.vehicle?.length} (Ft) ",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: SizeConfig.blockSizeHorizontal*3.2,
                              fontWeight: FontWeight.w400,
                            ...
                            children: [
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.w400)),
                              TextSpan(
                                  text: ' ${widget.postDetails[widget.postIndex].post?.advancePayment?.payBy} (${widget.postDetails[widget.postIndex].post?.advancePayment?.mode})',
                                  style: TextStyle(
                                      fontSize: SizeConfig.blockSizeHorizontal*2.5,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w400))
                                    ...
                                    children: [
                                      TextSpan(
                                          ...
                                          style: TextStyle(
                                              ...
                                              fontWeight: FontWeight.w400)),
                                      TextSpan(
                                          text: ' ${widget.postDetails[widget.postIndex].post?.deliveryPayment?.payBy} (${widget.postDetails[widget.postIndex].post?.deliveryPayment?.mode})',
                                          style: TextStyle(
                                              fontSize: SizeConfig.blockSizeHorizontal*2.5,
                                              color: Colors.black,
                                              fontWeight: FontWeight.w400))
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                for(int i = 0; i < (widget.postDetails[widget.postIndex].post?.loadDetail?.goodsImage?.length ?? 0); i++)
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                            child: Image.network("${ApiConstants().uploadImageUrl}${widget.postDetails[widget.postIndex].post?.loadDetail?.goodsImage?[i]}",
                              fit: BoxFit.cover,),
                          ),
                        ),
                      ],
