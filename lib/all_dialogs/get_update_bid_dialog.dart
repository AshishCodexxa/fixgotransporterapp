...
class BidUpdateNowPriceDialog extends StatefulWidget {
  ...
  const BidUpdateNowPriceDialog({Key? key, required this.isComeFrom, required this.mainPrice, required this.bidAmount, required this.postDetails, required this.postIndex, required this.companyName, required this.postId}) : super(key: key);

  @override
  State<BidUpdateNowPriceDialog> createState() => _BidUpdateNowPriceDialogState();
}

class _BidUpdateNowPriceDialogState extends State<BidUpdateNowPriceDialog> {
...
/*    int main = widget.mainPrice;
    ...
    pickUpLocation = "${widget.postDetails[widget.postIndex].post?.pickup?.address?.street}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.city}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.district}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.laneNumber}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.state}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.country}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.postalCode}";

    finalLocation = "${widget.postDetails[widget.postIndex].post?.receiver?.address?.street}, ${widget.postDetails[widget.postIndex].post?.receiver?.address?.city}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.district}, ${widget.postDetails[widget.postIndex].post?.pickup?.address?.laneNumber}, ${widget.postDetails[widget.postIndex].post?.receiver?.address?.state}, ${widget.postDetails[widget.postIndex].post?.receiver?.address?.country}, ${widget.postDetails[widget.postIndex].post?.receiver?.address?.postalCode}";
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("${widget.postDetails[widget.postIndex].post?.loadDetail?.load} ${widget.postDetails[widget.postIndex].post?.loadDetail?.loadUnit}",
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontFamily: 'Roboto_Regular',
                                                  fontWeight: FontWeight.w400,
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType != "Trailor" ?
                                  "Requirement : ${widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType}"
                                      : "Requirement : ${widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType} (${widget.postDetails[widget.postIndex].post?.vehicle?.vehicleType})",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontFamily: 'Roboto_Regular',
                                        fontWeight: FontWeight.w400,
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){
          ...
          ApiClient().uploadBidAgainstPost(widget.postId, vehiclePriceController.text).then((value){
            print(value['data']);
