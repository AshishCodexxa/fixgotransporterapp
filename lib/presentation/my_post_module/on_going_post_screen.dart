...
class OnGoingPostScreen extends StatefulWidget {
  const OnGoingPostScreen({Key? key}) : super(key: key);

  @override
  State<OnGoingPostScreen> createState() => _OnGoingPostScreenState();
}

class _OnGoingPostScreenState extends State<OnGoingPostScreen> {
