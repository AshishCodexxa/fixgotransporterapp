...
class CancelledPostScreen extends StatefulWidget {
  const CancelledPostScreen({Key? key}) : super(key: key);

  @override
  State<CancelledPostScreen> createState() => _CancelledPostScreenState();
}

class _CancelledPostScreenState extends State<CancelledPostScreen> {
